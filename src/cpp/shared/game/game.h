...
public:
  ...
  // New state
  int computerPlayerHeroForcedChase[NUM_PLAYERS][MAX_HEROES][NUM_PLAYERS];
  ...
  void ForceComputerPlayerHeroChase(int computerPlayer, int computerHero, int player, int hero);
